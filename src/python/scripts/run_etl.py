...
def main():
    """Main entry point"""
    parser = argparse.ArgumentParser(description="Snowflake ETL Pipeline Orchestrator")
    parser.add_argument(
        "--config",
        type=str,
    ...
    parser.add_argument(
        "--dry-run", action="store_true", help="Validate pipeline without executing queries"
    )
    parser.add_argument(
        "--log-level",
        type=str,
